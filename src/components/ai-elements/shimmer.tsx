  ...
  return (
    <MotionComponent
      ...
      className={cn(
        ...
        '[background-repeat:no-repeat,padding-box] [--bg:linear-gradient(90deg,#0000_calc(50%-var(--spread)),var(--shimmer-sweep,var(--color-background)),#0000_calc(50%+var(--spread)))]',
        className
      )}
