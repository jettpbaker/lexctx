...
function ChatSidebarRow({ chat, href, isActive, onEdit, onDelete }: ChatSidebarRowProps) {
  ...
  const rename = useInlineRename({
    value: fallbackTitle,
    onCommit: async (trimmedTitle) => {
      const previousTitle = fallbackTitle
  ...
  return (
    <SidebarMenuItem>
      <SidebarMenuButton
        ...
        isActive={isActive}
        render={rename.isEditing ? <div /> : <Link href={href} prefetch={true} />}
